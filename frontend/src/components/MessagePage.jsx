...
function MessagePage() {
  ...
  return (
    <div>
      ...
      {/* 聊天室 */}
      <section className="h-[calc(85vh)] overflow-hidden  overflow-y-scroll scrollbar relative bg-slate-200 bg-opacity-50">
        {/* 顯示上傳的圖片 */}
        {/* {message.imageUrl && (
            ...
            return (
              <nav
                className={`bg-white p-1 py-1 rounded w-fit ${
                  user.userId == message.sender ? "ml-auto bg-teal-100" : ""
                }`}
                key={index}
              >
                {/* 圖片 */}
        ...
        >
          <div className="col-span-3 flex items-center gap-2">
            ...
            <input
              ...
              className="px-3 py-2 outline-none flex-grow border rounded"
            />
